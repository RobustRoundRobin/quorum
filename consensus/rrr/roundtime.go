...
func NewRoundTime(roundLength uint64, confirmPhase uint64, logger log.Logger) *RoundTime {
	t := &RoundTime{}
...
func (t *RoundTime) Configure(roundLength uint64, confirmPhase uint64, logger log.Logger) {
